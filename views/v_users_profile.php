<pageInstruction> This is your profile for <?=$user->first_name."<br/>"; ?>, To change the visibility of your posts, Click 'Swith Visibility' button </pageInstruction>
 <br/>
...
<span id='privateInd'><?php if($user)    echo $user->deleted_ind;  ?> </span></div><br/>
 <div><?php if($user)   echo "&nbsp;&nbsp;<button onClick='javascript:switchVisibility();' id='switchVisibility'>Switch Visibility </button>"; ?></div>
