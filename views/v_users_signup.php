...
<form class='main' method='POST'  action='/users/p_signup'>
   First Name<br>
   <input type='text' maxlength="50" name='first_name'>
   <div class="error" id="firstNameValidation"> </div>
   <br>
   Last Name<br>
   <input type='text' maxlength="50" name='last_name'>
   <div class="error" id="lastNameValidation"> </div>
   <br><br>

   Email<br>
   <input type='text' maxlength="50" name='email' onchange='javascript:checkEmail();'>
   ...
   <input type='password' maxlength="50"  name='password' onKeyUp="javascript:displayStrength();">
   <div class="error" id="passwordValidation"> </div>
   <br>
   <div id="pwStrength">Password Strength:</div> 
      
   <br/>
   <div><button onclick="return onSubmit();">Add</button></div> 
</form>
